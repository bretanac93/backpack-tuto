...
class CommentCrudController extends CrudController
{
    public function setup()
    {
        ...
        // ------ CRUD FIELDS
        // $this->crud->addField($description_field, 'update/create/both');
        $this->crud->addFields([$description_field, $user_field, $post_field], 'both');
        ...
        $this->crud->setColumnDetails('post_id', [
            'label' => 'Post',
            'type' => 'select',
            'entity' => 'post',
            'attribute' => 'title'
